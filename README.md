...
* **Evidence:** [SCREENSHOT: PowerShell window showing 'Elastic Agent successfully installed'] 
...
* **Evidence:** [SCREENSHOT: Elastic Rule Editor showing the custom query and threshold settings]

### Phase 3: Alert Validation
* Validated the detection pipeline by re-running the Hydra brute-force simulation.
* Confirmed the rule triggered a "High" severity alert in the **Security Alerts** dashboard.
* **Evidence:** [SCREENSHOT: Elastic Alerts dashboard showing your 'Red' alert with a High Risk Score]
