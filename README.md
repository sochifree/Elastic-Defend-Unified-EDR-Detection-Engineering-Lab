...
* **Evidence:** ![Elastic Rule Editor showing the custom query](./img/screenshot(2008).png), ![png](./img/screenshot(2014).png)
...
* **Evidence:** [Elastic Alerts dashboard showing](./img/screenshot(2015).png), ![png](./img/screenshot(2016).png)
...
*![The "Under the Hood" JSON](./img/screenshot(2004).png), ![png](./img/screenshot(2018).png)
